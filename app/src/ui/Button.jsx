...
function Button({ children, disabled, to, type, onClick }) {
  ...
  if (to)
    ...
    ); // if the to prop is passed, we render a Link component that links to the to prop
  ...
  if (onClick)
    ...
    ); // if the onClick prop is passed, we render a button that calls the onClick function when clicked
